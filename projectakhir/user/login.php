        ...
        <div class="login-container text-c animated flipInX">
                ...
                <h2>Login</h2>
                    ...
                    <form method="post" action=" proses/proses_login.php">
                        ...
                        <p class="text-whitesmoke text-center mb-2"><small>Tidak Memiliki Akun?</small></p>
                        <a class="text-darkyellow mb-2" href="register.php"><small><center>Register</center></small></a>
                    </form>
