<?php
    ...
    $id = $_GET['id'];
    $data = $koneksi->query("SELECT * FROM judul_surah WHERE id = $id")->fetch_all();
...
<body id="page-top">
    <div id="wrapper">
        ...
        <h1 class="text-center mb-4">Edit Surah</h1>
        <form id="surahForm" method="POST" action="./proses/edit.php">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_arab" class="form-control" id="namaArab" value="<?= $nama_arab ?>" required>
            </div>
            <div class="mb-3">
                <label for="arti" class="form-label">Arti Surah</label>
                <input type="text" name="arti" class="form-control" id="arti" value="<?= $arti ?>" required>
            </div>
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-primary">Edit Surah</button>
            <a href="./admin_update.php" class="btn btn-warning">Batal Edit</a>
